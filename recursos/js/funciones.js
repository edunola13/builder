...
function add_com_builder(componente, fn_options){
	...
	//com+=   '<button type="button" class="btn btn-default btn-xs config pull-right">Personalize</button>';
	com+= '<div class="view">';
    com += componente;
    com += '</div></div>';
    return com;
...
function carga_ajax(json, fn_options){
    ...
    $.ajax({
        ...
        dataType: "html",
        success: function (msg) {
            msg= add_com_builder(msg, fn_options);
            $("#builder").append(msg);
...
function load_form(){
        ...
        carga_ajax_fn(json, load_form_sortable, load_form_options);
}
...
function load_select(){
    ...
    carga_ajax(json, load_select_options);
}
...
function load_checkbox(){        
    carga_ajax(checkbox(true), load_checkbox_options);
}
...
function load_radio(){
    carga_ajax(radio(false), load_radio_options);
}
...
function load_paginator(){
    ...
    carga_ajax(json, load_paginator_options);
}
...
function load_paragraph(){
    ...
    carga_ajax(json, load_paragraph_options);
}
...
function load_drop_down_menu(){
    ...
    carga_ajax(json, load_drop_down_menu_options);
}
...
function load_navigation_menu(){
    ...
    carga_ajax(json, load_navigation_menu_options);
}
...
function load_image(){
    ...
    carga_ajax(json, load_image_options);
}
...
function load_badge(){
    ...
    carga_ajax(json, load_badge_options);
}
...
function load_button(){
    ...
    carga_ajax(json, load_button_options);
}
...
function load_alertMessage(){
    ...
    carga_ajax(json, load_alertMessage_options);
}
...
function load_progressBar(){
    ...
    carga_ajax(json, load_progressBar_options);
}
...
function load_panel(){
    ...
    carga_ajax_fn(json, load_panel_sortable, null);
}
