...
<html lang="es">
  ...
  <body>
      <link class="estiloBuilder" href="<?php echo base()?>recursos/css/estilo.css" rel="stylesheet">
      <?php echo Tags::navigation_bar("Builder", base())?>
        <?php echo Tags::nav_bar_left();?>
            ...
            <?php echo Tags::nav_item_drop_down("Formulario");?>
                <?php echo Tags::menu_item("item_onclick", "Form", "load_form()"); ?>
                <?php echo Tags::menu_item("item_onclick", "Input", "load_input()"); ?>
                <?php echo Tags::menu_item("item_onclick", "Text Area", "load_textArea()"); ?>
                <?php echo Tags::menu_item("item_onclick", "Select", "load_select()"); ?>
                <?php echo Tags::menu_item("item_onclick", "Checkbox", "load_checkbox()"); ?>                
                <?php echo Tags::menu_item("item_onclick", "Radio", "load_radio()"); ?>
                <?php echo Tags::menu_item("item_onclick", "Buttons", "load_buttons()"); ?>
                <?php echo Tags::menu_item("divider");?>
                <?php echo Tags::menu_item("item_onclick", "Login", "load_login()"); ?>
            <?php echo Tags::end_nav_item_drop_down();?>
            <?php echo Tags::nav_item_drop_down("Navegacion");?>
            ...
            <?php echo Tags::end_nav_item_drop_down();?>
            <?php echo Tags::nav_item_drop_down("Otros");?>
            ...
            <?php echo Tags::end_nav_item_drop_down();?>
            <?php echo Tags::nav_item_drop_down("Charts");?>
                <?php echo Tags::menu_item("item_onclick", "Column Parsed", ""); ?>
            <?php echo Tags::end_nav_item_drop_down();?>
      ...
      <div class="jsBuilder">
        <script src="<?php echo base()?>recursos/js/jquery-ui.min.js"></script>
        <script src="<?php echo base()?>recursos/js/funciones.js"></script>
        <script id="events">
